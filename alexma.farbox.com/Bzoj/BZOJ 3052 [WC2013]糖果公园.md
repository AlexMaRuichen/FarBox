---
date: 2017-03-16 20:07
status: public
title: 'BZOJ 3052 [WC2013]糖果公园'
---
...
块的大小为$O(N ^ {2 / 3})$, 复杂度$O(N ^ {5 / 3})$, 不到$O(N^2)$

开始栈剩的点忘了压进最后一块, 多分了一块一个点跑了20s+

[vfk详细题解] (http://vfleaking.blog.163.com/blog/static/174807634201311011201627/)
